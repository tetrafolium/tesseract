...
public:
  ...
  inT16 fontinfo_id() const { return fontinfo_id_; }
  inT16 fontinfo_id2() const { return fontinfo_id2_; }
  ...
  inT16 xgap_before() const { return xgap_before_; }
  inT16 xgap_after() const { return xgap_after_; }
  ...
  void set_xgap_before(inT16 gap) { xgap_before_ = gap; }
  void set_xgap_after(inT16 gap) { xgap_after_ = gap; }
...
public:
  ...
  WERD_CHOICE(const char *src_string, const char *src_lengths, float src_rating,
              float src_certainty, uinT8 src_permuter,
  ...
  inline uinT8 permuter() const { return permuter_; }
  ...
  inline void set_permuter(uinT8 perm) { permuter_ = perm; }
