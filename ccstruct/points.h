...
public:
  ...
  /// access function
  inT16 x() const { return xcoord; }
  /// access_function
  inT16 y() const { return ycoord; }
  ...
  /// find sq length
  float sqlength() const { return (float)(xcoord * xcoord + ycoord * ycoord); }
  ...
  /// find angle
  float angle() const { return (float)atan2((double)ycoord, (double)xcoord); }
  ...
  void setup_render(ICOORD *major_step, ICOORD *minor_step, int *major,
                    int *minor) const;
...
class DLLSYM ICOORDELT : public ELIST_LINK,
                         public ICOORD
// embedded coord list
{
public:
...
public:
  ...
  /// find sq length
  float sqlength() const { return xcoord * xcoord + ycoord * ycoord; }
  ...
  /// find angle
  float angle() const { return (float)atan2(ycoord, xcoord); }
