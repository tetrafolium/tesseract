...
public class SVWindow extends JFrame {
  ...
  public void drawPolyline() {
    ...
    PPath pn = PPath.createLine(
        ScrollView.polylineXCoords[0], ScrollView.polylineYCoords[0],
        ScrollView.polylineXCoords[1], ScrollView.polylineYCoords[1]);
    pn.reset();
  ...
  public SVWindow(String name, int hash, int posX, int posY, int sizeX,
    ...
    if (winSizeX > canvasSizeX || winSizeY > canvasSizeY) {
      initialScalingfactor =
          Math.min(1.0 * winSizeX / canvasSizeX, 1.0 * winSizeY / canvasSizeY);
    }
  ...
  public void pen(int red, int green, int blue) { pen(red, green, blue, 255); }
  ...
  public void showInputDialog(String msg, String def, int id,
    ...
    String tmp = (String)JOptionPane.showInputDialog(
        this, msg, "", JOptionPane.QUESTION_MESSAGE, null, null, def);
  ...
  public void showYesNoDialog(String msg) {
    ...
    int res = JOptionPane.showOptionDialog(
        this, msg, "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE,
        null, null, null);
    SVEvent e = null;
  ...
  public void destroy() {
    ScrollView.addMessage(
        new SVEvent(SVEventType.SVET_DESTROY, this, 0, "SVET_DESTROY"));
    setVisible(false);
    // dispose();
  }
}
