 ...
 */
public class SVEventHandler extends PBasicInputEventHandler
  ...
  public void mouseClicked(PInputEvent e) {
    if (e.isPopupTrigger()) {
      ...
      processEvent(new SVEvent(SVEventType.SVET_CLICK, svWindow,
  ...
  public void mouseDragged(PInputEvent e) {
    processEvent(new SVEvent(
        SVEventType.SVET_MOUSE, svWindow, (int)e.getPosition().getX(),
        (int)e.getPosition().getY(), (int)e.getPosition().getX() - lastX,
  ...
  public void mouseReleased(PInputEvent e) {
    if (e.isPopupTrigger()) {
      ...
      processEvent(new SVEvent(
          SVEventType.SVET_SELECTION, svWindow, (int)e.getPosition().getX(),
          (int)e.getPosition().getY(), (int)e.getPosition().getX() - lastX,
          (int)e.getPosition().getY() - lastY, null));
    }
    if (selection != null) {
  ...
  public void mouseWheelRotated(PInputEvent e) {
    ...
    lc.scaleViewAboutPoint(lc.getScale() / sf, e.getPosition().getX(),
                           e.getPosition().getY());
  }
  ...
  public void mouseMoved(PInputEvent e) {
    processEvent(new SVEvent(SVEventType.SVET_MOTION, svWindow,
                             (int)e.getPosition().getX(),
                             (int)e.getPosition().getY(), 0, 0, null));
  }
